...
# 定义要执行的命令
command = "aria2c -s 8 -x 16 -i /data/haocheng/data/ACAT/txt/HG_2.txt -d /data/haocheng/data/bam/HG"
# 使用 subprocess 运行命令
try:
...
# 设置BAM文件目录
bam_dir = "/data/haocheng/data/bam/HG/"
...
# 源文件路径
src_file = "/data/haocheng/data/bam/HG/sample1_signal.bed"
# 目标文件路径
dest_file = "/data/haocheng/data/bam/result/HG_2.bed"
...
# 设置要删除文件的目录
directory = "/data/haocheng/data/bam/HG"
...
# 定义要执行的命令
command = "aria2c -s 8 -x 16 -i /data/haocheng/data/ACAT/txt/HG_3.txt -d /data/haocheng/data/bam/HG"
# 使用 subprocess 运行命令
try:
    subprocess.run(command, shell=True, check=True)
    print("Download completed successfully.")
...
src_file = "/data/haocheng/data/bam/HG/sample1_signal.bed"
# 目标文件路径
dest_file = "/data/haocheng/data/bam/result/HG_3.bed"
