...
# 定义BigWig文件路径
bw2_files <- list.files("/data/haocheng/data/ACAT/HG/", pattern = "*.bigWig", full.names = TRUE)
...
parLapply(cl, unique(seqnames(result)), function(chr) {
  export(result[seqnames(result) == chr], paste0("/data/haocheng/data/result/HG/",count,"HG_result_", chr, ".bigWig"))}
